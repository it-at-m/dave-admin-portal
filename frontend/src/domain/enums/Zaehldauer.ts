...
export const zaehldauerDropDown = new Array<KeyVal>(
    {value: Zaehldauer.DAUER_2_X_4_STUNDEN, text: 'Kurzzeiterhebung (6 bis 10 Uhr; 15 bis 19 Uhr)'},
    {value: Zaehldauer.DAUER_13_STUNDEN, text: '13 Stunden Zählung (6 bis 19 Uhr)'},
    {value: Zaehldauer.DAUER_16_STUNDEN, text: '16 Stunden Zählung (6 bis 22 Uhr)'},
