...
import ConfigInfoMessageEdit from "@/components/config/subconfig/ConfigInfoMessageEdit.vue";
import ConfigInfoMessageHistory from "@/components/config/subconfig/ConfigInfoMessageHistory.vue";
