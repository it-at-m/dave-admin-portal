<template>
  <v-sheet width="100%" :height="height" :max-height="height" class="overflow-y-auto">
    <v-card-text>
      ...
      <v-row dense>
        <v-col cols="12" md="4">
          <v-checkbox v-model="zaehlung.kreisverkehr"
                      @change="updateStore"
                      label="Kreisverkehr"
                      color="grey darken-1"
                      hide-details
      ...
      <v-row dense>
        <v-col cols="12" md="4">
          <v-text-field label="Kreuzungsname"
      ...
      <v-row no-gutters dense>
        <v-col cols="12" md="7">
          <v-row no-gutters dense>
            <v-text-field label="Straßenname Knotenarm 1"
                          v-model="strassen[0]"
                          single-line
                          dense
          ...
          <v-row no-gutters dense>
            <v-text-field label="Straßenname Knotenarm 2"
                          v-model="strassen[1]"
                          single-line
                          dense
          ...
          <v-row no-gutters dense>
            <v-text-field label="Straßenname Knotenarm 3"
                          v-model="strassen[2]"
                          single-line
                          dense
          ...
          <v-row no-gutters dense>
            <v-text-field label="Straßenname Knotenarm 4"
                          v-model="strassen[3]"
                          single-line
                          dense
          ...
          <v-row no-gutters dense>
            <v-text-field label="Straßenname Knotenarm 5"
                          v-model="strassen[4]"
                          single-line
                          dense
          ...
          <v-row no-gutters dense>
            <v-text-field label="Straßenname Knotenarm 6"
                          v-model="strassen[5]"
                          single-line
                          dense
          ...
          <v-row no-gutters dense>
            <v-text-field label="Straßenname Knotenarm 7"
                          v-model="strassen[6]"
                          single-line
                          dense
          ...
          <v-row no-gutters dense>
            <v-text-field label="Straßenname Knotenarm 8"
                          v-model="strassen[7]"
                          single-line
                          dense
...
export default class KnotenLageForm extends Vue {
  ...
  addOrUpdateStrassenname(nummer: number, name: string) {
    ...
    if (name === null || name === undefined || name.trim() === '') {
      ...
      this.$store.dispatch("addOrUpdateKnotenarm", _.cloneDeep(knotenarm));
    }
  }
